      ...
      <div className='wrapper flex flex-col space-y-2 text-left'>
        ...
        <div className='register_container space-y-2'>
          ...
          <div className='field listen'>
            <label>
              How do you listen to Sea FM? (tick as many as you wish)
            </label>
            <ul>
          ...
          <div className='field offers'>
            ...
            />
            <label htmlFor='offers' className='checkbox'>
        ...
        <div className='page_options flex flex-row space-x-1'>
          <button
            className='register_btn login_btn button text-white border-2 bg-btn-green px-3 py-2 last:rounded '
            onClick={register}
          >
            Activate Now!
          </button>
